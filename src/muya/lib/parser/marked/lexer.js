      ...
      for (; i < l; i++) {
        ...
        if (i === 0) {
          ...
          ((!isOrdered && !newIsOrdered && bull !== newBull) ||
            ...
            // Changing to/from task list item from/to bullet, starts a new list(work for jsmarknote issue #870)
            // Because we distinguish between task list and bullet list in JsMarkNote,
