...
let onLanguageChangedCallback = null

/**
 * Sets the preferences instance for saving language settings
 * @param {object} preferences - The preferences instance
 */
export function setPreferencesInstance(preferences) {
  preferencesInstance = preferences
}

export function setOnLanguageChanged(callback) {
...
export function setLanguage(language) {
  ...
  if (preferencesInstance) {
    preferencesInstance.setItem('language', language)
  }
  ...
  // Notify main process menu to rebuild
