...
import { checkUpdates } from '../actions/jsmarknote'
import { t } from '../../i18n'
...
const isUpdatable = () => {
  ...
  if (!resFile) {
    ...
    return true
  } else if (process.platform === 'win32' && isFile(path.join(process.resourcesPath, 'icon.ico'))) {
    ...
    submenu: [
      {
        ...
        click() {
          shell.openExternal(
            'https://github.com/jsmarknote/jsmarknote/blob/trunk/docs/MARKDOWN_SYNTAX.md'
          )
        }
      },
      {
        ...
        click() {
          shell.openExternal('https://github.com/jsmarknote/jsmarknote/releases')
        }
      },
      {
        type: 'separator'
      },
      {
        ...
        click() {
          shell.openExternal('https://github.com/jsmarknote/jsmarknote/discussions')
        }
      },
      {
        label: t('menu.help.reportBug'),
        click() {
          shell.openExternal('https://github.com/jsmarknote/jsmarknote/issues')
        }
      },
      {
        label: t('menu.help.viewSource'),
        click() {
          shell.openExternal('https://github.com/jsmarknote/jsmarknote')
        }
      },
      {
        type: 'separator'
      },
      {
        ...
        click() {
          shell.openExternal('https://github.com/jsmarknote/jsmarknote/blob/trunk/LICENSE')
        }
      }
    ]
  }
