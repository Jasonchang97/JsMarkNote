...
import { setLanguage, setPreferencesInstance } from '../i18n'
...
class App {
  ...
  async _initializeLanguage() {
    try {
      // Set preferences instance for i18n module to save language settings
      setPreferencesInstance(this._accessor.preferences)
