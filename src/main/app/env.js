...
const setupEnvironment = args => {
  ...
  const debug = args['--debug'] || !!process.env.JSMARKNOTE_DEBUG || process.env.NODE_ENV !== 'production'
  ...
  global.JSMARKNOTE_DEBUG = debug
  global.JSMARKNOTE_DEBUG_VERBOSE = verbose
  global.JSMARKNOTE_SAFE_MODE = safeMode
