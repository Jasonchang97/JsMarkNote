...
process.env.JSMARKNOTE_VERSION = JSMARKNOTE_VERSION
process.env.JSMARKNOTE_VERSION_STRING = JSMARKNOTE_VERSION_STRING
...
electronApp.setAppUserModelId('com.electron.jsmarknote')
