...
onMounted(async () => {
  if (global.jsmarknote.initialState) {
    preferencesStore.SET_USER_PREFERENCE(global.jsmarknote.initialState)
  }
  ...
  nextTick(() => {
    const style = global.jsmarknote.initialState || DEFAULT_STYLE
    addStyles(style)
  })
})
</script>
