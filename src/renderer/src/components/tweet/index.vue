...
const reportViaGithub = () => {
  window.electron.shell.openExternal('https://github.com/jsmarknote/jsmarknote/issues/new')
}
...
const reportViaTwitter = () => {
  ...
  const params = {
    via: 'jsmarknoteme',
    url: encodeURI('https://github.com/jsmarknote/jsmarknote/'),
    text: value.value
  }

  if (selectedFace.value === 'smile') {
    params.hashtags = 'happyJsMarkNote'
  }
