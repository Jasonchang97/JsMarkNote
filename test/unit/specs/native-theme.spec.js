...
describe('Native theme source', () => {
  ...
  it('uses dark native menus for dark JsMarkNote themes', () => {
  ...
  it('uses the shared JsMarkNote dark theme classification', () => {
  ...
  it('uses light native menus for light JsMarkNote themes', () => {
